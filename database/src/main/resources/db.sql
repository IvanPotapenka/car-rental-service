...
VALUES ('WHITE', 5, '1092873', 5, 587, '123-0948098j882d', 'Audy', 1.5, 7, 'DIESEL', 125, 'AUTOMATIC',
        'A8', 102, 2020);

INSERT INTO car
(color, quantity_doors, numbers, quantity_places, trunk_volume, vin_code, brand, engine_capacity,
 fuel, fuel_consumption, horse_power, transmission, model, price, year_of_release)
VALUES ('WHITE', 5, '1876786', 5, 580, '123-0945656876', 'BMW', 1.5, 'DIESEL', 7.4, 124, 'AUTOMATIC',
        'A8', 102, 2020);

INSERT INTO client (first_name, last_name, phone, address, date_of_birthday,
                    date_of_creation)
VALUES ('Ivan', 'Potapenko', '+375447899840', 'Gomel,Mazurova,20', '1986-05-02',
        '2023-05-02');
...
INSERT INTO documents(client_id, passport_No, driver_license_No)
VALUES (1, '1209838', 'PAO123986');
