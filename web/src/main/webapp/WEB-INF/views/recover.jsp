...
<%@include file="header.jsp" %>
    ...
    <a href="${pageContext.request.contextPath}/recover">/ recover</a></div>
        <box>
            <form method="post" class="w3-card-4 w3-blue-grey w3-round-large w3-padding" style="width: 30%">
                <flex>
                    ...
                    <p class="w3-text-red"> There is no user with this address or <a href="/recover"class="w3-text-blue" >try again</a></p>
                    ...
                    <input class="w3-round-large"
                            ...
                            id="email"
                            required/></p>
                    <button class="w3-btn w3-white w3-round-large" type="submit">Recover</button></br>
                    </c:if>
                </flex>
            </form>
        </box>
