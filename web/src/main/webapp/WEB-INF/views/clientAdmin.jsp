            ...
            <c:if test="${client_id == true || create_client == true}">
                ...
                <table style="font-size: 10px">
                    ...
                    <tr>
                        ...
                        <td><a href="${pageContext.request.contextPath}/admin/clients/client/delete_client?id=${client.id}"
                               class="w3-text-red">DELETE</a></td>
                        <td><a href="${pageContext.request.contextPath}/admin/clients/client/update_client?id=${client.id}"
